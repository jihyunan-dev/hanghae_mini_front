export const RESP = {
  // 회원가입
  REGISTER_SUCCESS: { ok: true, message: "회원가입 성공!" },
  REGISTER_FAIL: { ok: false, message: "회원가입 실패!" },
  ...
  LOGIN_FAIL: { ok: false, message: "로그인 정보가 틀렸습니다!" },
  ...
  MENU_FAIL: { ok: false, message: "메뉴 가져오기 실패!" },

  // 선택된 메뉴 인기순위 업데이트
  LIKE_SUCCESS: { ok: true, message: "좋아요 성공!" },
  LIKE_FAIL: { ok: false, message: "좋아요 실패!" },
  ...
  RANKLIST_FAIL: { ok: false, message: "순위 불러오기 실패!" },
  ...
  MENU_DETAIL_FAIL: { ok: false, message: "메뉴 상세 가져오기 실패!" },

  // 메뉴 등록하기
  MENU_UPLOAD: { ok: true, message: "메뉴등록 성공!" },
  MENU_UPLOAD_FAIL: { ok: false, message: "메뉴등록 실패!" },

  // 메뉴 수정하기
  MENU_CHANGE_SUCCESS: { ok: true, message: "메뉴수정 성공!" },
  MENU_CHANGE_FAIL: { ok: false, message: "메뉴수정 실패!" },

  // 메뉴 삭제하기
  MENU_DELETE_SUCCESS: { ok: true, message: "메뉴삭제 성공!" },
  MENU_DELETE_FAIL: { ok: false, message: "메뉴삭제 실패!" },
  ...
  COMMENT_FAIL: { ok: false, message: "댓글을 불러오기 실패!" },
};
